...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "#0f1117" }}>
      ...
      >
        <div
          className="absolute top-[-80px] left-[-80px] w-[400px] h-[400px] rounded-full opacity-10"
          style={{ background: "radial-gradient(circle, #10b981, transparent)" }}
        />
        <div
          className="absolute bottom-[-100px] right-[-60px] w-[350px] h-[350px] rounded-full opacity-10"
          style={{ background: "radial-gradient(circle, #10b981, transparent)" }}
        />
        ...
        <div className="relative z-10">
          ...
          <div>
            <h1 className="text-5xl font-bold leading-tight mb-6" style={{ color: "#f1f5f9" }}>
              Join the
              <br />
              <span style={{ color: "#10b981" }}>Healthcare</span>
              <br />
              Network
            </h1>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {[
              { key: "name", label: "Full Name", type: "text", placeholder: "Nishikant Kshirsagar" },
              ...
              <div key={field.key}>
                ...
                <input
                  ...
                  required
                  minLength={field.key === "name" ? 3 : field.key === "password" ? 6 : undefined}
          ...
          <p className="mt-8 text-center text-sm" style={{ color: "#94a3b8" }}>
            ...
            <Link to="/" className="font-semibold" style={{ color: "#10b981" }}>
              Sign in
            </Link>
          </p>
