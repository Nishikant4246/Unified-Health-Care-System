      ...
      >
        <div>
          <div className="flex items-center gap-3 px-4 py-5" style={{ borderBottom: '1px solid #2a2d3e' }}>
            ...
            {!collapsed && (
              <div>
                <div className="text-sm font-bold" style={{ color: '#f1f5f9' }}>UHCS Doctor</div>
                <div className="text-xs" style={{ color: '#3b82f6' }}>Medical Portal</div>
              </div>
            )}
          </div>
          ...
          {!collapsed && (
            <div className="flex items-center gap-3 px-3 py-2 rounded-lg mb-2"
              ...
              <div className="min-w-0">
                ...
                <div className="text-xs font-mono" style={{ color: '#3b82f6' }}>{user?.uniqueId}</div>
              </div>
            </div>
          )}
          <button
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        <header className="flex items-center justify-between px-6 py-4 flex-shrink-0"
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs" style={{ color: '#94a3b8' }}>Doctor Portal Active</span>
          </div>
        </header>
