...
const navItems = [
  ...
  { to: "/patient/lab-reports", label: "Lab Reports", labelKey: "labReports", icon: <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path d="M9 3v6.5L4.5 17A2 2 0 006.2 20h11.6a2 2 0 001.7-3L15 9.5V3"/><line x1="8" y1="3" x2="16" y2="3"/><line x1="8.5" y1="14" x2="15.5" y2="14"/></svg>, },
